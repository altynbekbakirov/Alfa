...
public class SalesClientManager {
    ...
    public SalesClientManager() {
    }

    public SalesClientManager(String clientCode, String clientName, Double itemAmount, Double itemTotal, Double itemTotalUsd, Double itemAmountRet, Double itemTotalRet, Double itemTotalUsdRet) {
