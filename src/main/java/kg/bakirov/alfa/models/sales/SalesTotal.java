...
public class SalesTotal {
    ...
    public SalesTotal(String code, String name, String group, Double purchaseCount, Double purchaseTotal, Double purchaseTotalUsd, Double saleCount, Double saleTotal, Double saleTotalUsd) {
        this.code = code;
        this.name = name;
        this.group = group;
