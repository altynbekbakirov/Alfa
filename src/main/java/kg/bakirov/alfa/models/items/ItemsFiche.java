...
public class ItemsFiche {

    private String item_trCode;
    private Long item_ficheNo;
    ...
    public ItemsFiche(String item_trCode, Long item_ficheNo, String item_date, String item_clientCode, String item_clientName, double item_gross, double item_discounts, double item_expenses, double item_net, String item_type) {
    ...
    public String getItem_trCode() {
        return item_trCode;
    }

    public void setItem_trCode(String item_trCode) {
        this.item_trCode = item_trCode;
    }

    public Long getItem_ficheNo() {
        return item_ficheNo;
    }

    public void setItem_ficheNo(Long item_ficheNo) {
        this.item_ficheNo = item_ficheNo;
    }
