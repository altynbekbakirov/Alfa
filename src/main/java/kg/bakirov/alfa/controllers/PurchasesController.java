...
public class PurchasesController {
    ...
    @Autowired
    public PurchasesController(MainRepository mainRepository, ItemsRepository itemsRepository) {
    ...
    @PostMapping("/fiche")
    public String purchaseFichePost(@RequestParam("firmno") int firmno, @RequestParam("periodno") int periodno,
        ...
        model.addAttribute("activePage", "purchaseFiche");
        model.addAttribute("pageTitle", "Список документов закупки");
        ...
        return "purchases/purchaseFiche";
    }

    @GetMapping("/fiche")
    public String purchaseFiche(Model model) {
    ...
    @PostMapping("/clients")
    public String purchaseClientsPost(@RequestParam("firmno") int firmno, @RequestParam("periodno") int periodno,
                                      @RequestParam("begdate") String begdate, @RequestParam("enddate") String enddate,
                                      @RequestParam(required = false, name = "account1") String account1,
        ...
        model.addAttribute("activePage", "purchaseClient");
        model.addAttribute("pageTitle", "Распределение продаж по поставщикам");
        model.addAttribute("firms", firmList);
        model.addAttribute("periods", periods);
        model.addAttribute("firmno", GLOBAL_FIRM_NO);
        model.addAttribute("periodno", GLOBAL_PERIOD);
        ...
        return "purchases/purchaseClients";
    }

    @GetMapping("/clients")
    public String purchaseClients(Model model) {
    ...
    public String getTotalPost(@RequestParam("firmno") int firmno, @RequestParam("periodno") int periodno,
        ...
        model.addAttribute("activePage", "purchaseTotal");
        model.addAttribute("pageTitle", "Итоговые цифры закупок");
        model.addAttribute("firms", firmList);
        model.addAttribute("periods", periods);
        model.addAttribute("firmno", GLOBAL_FIRM_NO);
        model.addAttribute("periodno", GLOBAL_PERIOD);
        ...
        return "purchases/purchaseTotal";
    }


    @GetMapping("/total")
    public String getTotalPurchases(Model model) {
    ...
    public String getMonthPost(@RequestParam("firmno") int firmno, @RequestParam("periodno") int periodno,
        ...
        model.addAttribute("activePage", "purchaseMonth");
        model.addAttribute("pageTitle", "Распределение закупок по месяцам");
        model.addAttribute("firms", firmList);
        model.addAttribute("periods", periods);
        model.addAttribute("firmno", GLOBAL_FIRM_NO);
        model.addAttribute("periodno", GLOBAL_PERIOD);
        ...
        return "purchases/purchaseMonth";
    }

    @GetMapping("/month")
    public String purchaseMonth(Model model) {
