        ...
        var table = $('#kt_datatable').DataTable({
            ...
            ajax: {
                ...
                data: {
                    ...
                    columnsDef: [
                        'code', 'name', 'itemGroup', 'retCount', 'retTotal', 'retCost', 'saleCount', 'saleTotal', 'saleCost', 'profitTotal', 'profitPercent'],
                },
            },
            columns: [
                {data: 'code'},
                ...
                {data: 'itemGroup'},
                {data: 'retCount'},
                {data: 'retTotal', render: $.fn.dataTable.render.number(' ', '.', 2, '$')},
                {data: 'retCost', render: $.fn.dataTable.render.number(' ', '.', 2, '$')},
                {data: 'saleCount'},
                {data: 'saleTotal', render: $.fn.dataTable.render.number(' ', '.', 2, '$')},
                {data: 'saleCost', render: $.fn.dataTable.render.number(' ', '.', 2, '$')},
                {data: 'profitTotal', render: $.fn.dataTable.render.number(' ', '.', 2, '$')},
                {data: 'profitPercent'}
            ],
            /*"rowCallback": function ( row, data ) {
                if ( data[10].replace(/[\$,]/g, '') * 1 < 0 ) {
                    $('td:eq(10)', row).html( '<b>A</b>' );
                }
            }*/

            createdRow: function (row, data, index) {
                var cell = $('td', row).eq(10);
                ...
                cell.html(KTUtil.numberString(data['profitPercent'] + '%'));
            },
        });
