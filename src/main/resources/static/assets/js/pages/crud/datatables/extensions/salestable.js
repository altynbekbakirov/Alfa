        ...
        var table = $('#kt_datatable').DataTable({
            ...
            footerCallback: function (row, data, start, end, display) {
                ...
                $(api.column(column5).footer()).html(
                    '$' + KTUtil.numberString(pageTotal5.toFixed(2)) + '<br/> ($' + KTUtil.numberString(total4.toFixed(2)) + ')',
                );
            ...
            ajax: {
                ...
                data: {
                    ...
                    columnsDef: [
                        'date', 'total', 'expenses', 'discounts', 'net', 'returnAmount', 'net_usd']
                },
            },
            columns: [
                {data: 'date'},
                ...
                {data: 'returnAmount', render: $.fn.dataTable.render.number(' ', '.', 2)},
                {data: 'net_usd', render: $.fn.dataTable.render.number(' ', '.', 2, '$')}
            ]
        });
