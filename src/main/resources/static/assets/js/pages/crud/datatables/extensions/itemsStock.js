        ...
        var table = $('#kt_datatable').DataTable({
            ...
            ajax: {
                ...
                data: {
                    ...
                    columnsDef: [
                        'item_code', 'item_name', 'item_group', 'item_purAmount', 'item_purCurr', 'item_salAmount', 'item_salCurr', 'item_onHand', 'item_lastTrDate']
                },
            },
            columns: [
                {data: 'item_code'},
                {data: 'item_name'},
                {data: 'item_group'},
                {data: 'item_purAmount', render: $.fn.dataTable.render.number(' ', '.', 0)},
                {data: 'item_purCurr', render: $.fn.dataTable.render.number(' ', '.', 2, '$')},
                {data: 'item_salAmount', render: $.fn.dataTable.render.number(' ', '.', 0)},
                {data: 'item_salCurr', render: $.fn.dataTable.render.number(' ', '.', 2, '$')},
                {data: 'item_onHand', render: $.fn.dataTable.render.number(' ', '.', 0)},
                {data: 'item_lastTrDate'}
            ],
