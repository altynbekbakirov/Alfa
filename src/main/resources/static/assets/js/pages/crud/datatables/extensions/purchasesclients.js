    ...
    var initTable = function () {
        ...
        var table = $('#kt_datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'itemTotal', render: $.fn.dataTable.render.number(' ', '.', 2)},
                {data: 'itemTotalUsd', render: $.fn.dataTable.render.number(' ', '.', 2, '$')},
                {data: 'itemAmountRet', render: $.fn.dataTable.render.number(' ', '.', 0)},
                {data: 'itemTotalRet', render: $.fn.dataTable.render.number(' ', '.', 2)},
                {data: 'itemTotalUsdRet', render: $.fn.dataTable.render.number(' ', '.', 2, '$')}
            ],
            order: [[0, 'asc']],
