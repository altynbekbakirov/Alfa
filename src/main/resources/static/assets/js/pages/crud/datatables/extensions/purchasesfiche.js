    ...
    var initTable = function () {
        ...
        var table = $('#kt_datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'clientCode'},
                {data: 'clientName'},
                {data: 'gross', render: $.fn.dataTable.render.number(' ', '.', 0)},
                {data: 'discounts', render: $.fn.dataTable.render.number(' ', '.', 0)},
                {data: 'expenses', render: $.fn.dataTable.render.number(' ', '.', 0)},
                {data: 'net', render: $.fn.dataTable.render.number(' ', '.', 0)},
                {data: 'netUsd', render: $.fn.dataTable.render.number(' ', '.', 0, '$')}
            ]
        });
...
jQuery(document).ready(function () {
    ...
    $('#firmno').on('change', function () {
        ...
        $.ajax({
            url: '/api/purchases/accountsList/' + firmNo,
            type: 'get',
            contentType: 'application/json',
            dataType: 'json',
            success: function (response) {
